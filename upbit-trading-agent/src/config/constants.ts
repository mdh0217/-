...
export const TRADING = {
  ...
  /**
   * 트레일링 스탑 활성화: 평단 대비 +2.5%
   * (기존 +3% → 소폭 하향: 작은 수익도 조기에 보호)
   */
  TRAILING_ACTIVATE_RATE: 0.025,

  /**
   * 트레일링 스탑 익절 트리거: 고점 대비 -2.5%
   * (기존 -1.5% → 확대: 크립토 노이즈 변동폭 내 조기 청산 방지)
   */
  TRAILING_TRIGGER_RATE: 0.025,
